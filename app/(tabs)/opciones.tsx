  ...
  const options = [
    ...
    },
    {
      icon: () => (
        <Image
          source={{
            uri: "https://teteocan.com/wp-content/uploads/2025/06/fav.png",
          }}
          style={{
            width: 32,
            height: 26,
        ...
        {loading ? (
          ...
          <>
                        ...
                        <View className="mt-1">
                          <Slider
                            ...
                            minimumTrackTintColor={
                              Colors[currentTheme as keyof typeof Colors].tint
                            }
                            ...
                            thumbStyle={{
                              ...
                              width: 14,
                              backgroundColor:
                                Colors[currentTheme as keyof typeof Colors]
                                  .tint,
                              borderRadius: 7,
                            }}
                            trackStyle={{
                          ...
                          />
                          <Text className={`text-xs mt-1 ${subtitleColor}`}>
                            Rango: {searchRange} km
                          </Text>
                        </View>
                      ) : (
                        <Text
            ...
            <View className="w-full space-y-3">
              <Text className={`font-semibold ${textColor} text-center`}>
                v {appData?.version}
              </Text>
            </View>
          </>
